                    ...
                    {country.borders != null && (<div className="border">
                            ...
                            <div className='border-grid'>
                            {
                                country.borders.map((item,index) => (
                                    <div key={index} style={{fontSize:findCountryByCode(item).length>13?"1vw":"0.7vw" , backgroundColor:preferredTheme.elementColor,color:preferredTheme.textColor}} className="border-country">
